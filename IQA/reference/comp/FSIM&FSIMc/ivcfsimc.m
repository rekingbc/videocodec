...
[FSIM(i,1), FSIMc(i,1)] = FeatureSIM( ref_img, dst_img);
end
    % VSI与MOS求Krocc
...
%%
    ...
    Srocc = corr(MOS_2,FSIMc,'type','spearman');
     Krocc = corr(MOS_2,FSIMc,'type','kendall');
toc
%%
save  ivcfsimc FSIMc Srocc Krocc MOS_2 